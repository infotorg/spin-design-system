/**
 * This is Spin Design System’s helper util that
      ...
      if (sidebar) {
        ...
        if (subNavLinks) {
          ;[].forEach.call(subNavLinks, function(element) {
            element.classList.add('nav-sub-item');

            element.removeEventListener("click", self.selectItem.bind(self), false)
            element.addEventListener("click", self.selectItem.bind(self), false)
          })
        }
      }
    },
