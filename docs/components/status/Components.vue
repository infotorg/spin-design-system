<template>
  <div class="component-status">
    <ul class="status-list">
      <li>
        <sp-icon name="ready" fill="#7cb518" size="small"/>
        <p>Ready</p>
      </li>
      <li>
        <sp-icon name="review" :fill="tokens.color_ucla_gold.value" size="small"/>
        <p>Under review</p>
      </li>
      <li>
        <sp-icon name="deprecated" :fill="tokens.color_vermilion.value" size="small"/>
        <p>Deprecated</p>
      </li>
      <li>
        <sp-icon name="prototype" :fill="tokens.color_bleu_de_france.value" size="small"/>
        <p>Prototype</p>
      </li>
      <li>
        <span>—</span>
      ...
      <tbody>
        <tr v-for="(component, index) in components" :key="index" class="component">
          ...
          <td v-if="component.status">
            <sp-icon v-if="component.status === 'ready'" name="ready" fill="#7cb518" size="small"/>
            <sp-icon
...
import SpIcon from "../../../src/elements/SpIcon"
