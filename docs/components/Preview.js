...
export default previewComponent => {
  ...
  return {
    ...
    created() {
      ...
      Object.entries(Vue.options.components)
          .forEach(c => {
            const component = c[1];
            const { name, displayName } = component.extendOptions;

            // If display name is different than name, create an alias of the component
            // Ex: SpAlert component displayName is Alert
            //     We then create SpAlert, an alias of Alert, to be used in <docs> block
