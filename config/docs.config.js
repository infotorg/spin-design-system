...
module.exports = {
  ...
  /**
   * Enabling the below option will break things in Spin Design System!
   */
  ...
  sections: [
    ...
    },
    {
      ...
      components: () => [
        ...
        "../docs/components/tokens/FontWeight.vue",
   ...
   */
  template: {
    title: "Example — Spin Design System",
    lang: "en",
    trimWhitespace: true,
    head: {
      meta: [
            ...
            "sass-loader",
            {
              ...
              options: {
                resources: [
                  ...
                  path.join(__dirname, "../src/styles/bootstrap/index.scss"),

                  // --- Bootstrap SCSS ---
                  path.join(__dirname, "../node_modules/bootstrap/scss/bootstrap.scss"),

                  // --- BootstrapVue SCSS ---
                  // path.join(__dirname, "../node_modules/bootstrap-vue/src/index.scss"),

                  // --- SPIN Design System SCSS ---
  ...
  printBuildInstructions(config) {
    console.log(chalk.cyan("\n  Design System Docs build finished successfully!\n"))
    console.log(
      chalk.yellow(
